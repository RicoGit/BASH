...
JAVA_OPTS="$JAVA_OPTS -Djboss.partition.name=ShamrockPartition"

# Sun JVM memory allocation pool parameters. Modify as appropriate.
JAVA_OPTS="$JAVA_OPTS -server -XX:MaxPermSize=256m -Xms128m -Xmx1024m -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000"

# JPDA options. Uncomment and modify as appropriate to enable remote debugging.
JAVA_OPTS="-Xdebug -Xrunjdwp:transport=dt_socket,address=8787,server=y,suspend=n $JAVA_OPTS"

JAVA_OPTS="$JAVA_OPTS -Djavax.management.builder.initial=org.jboss.system.server.jmx.MBeanServerBuilderImpl -Djboss.platform.mbeanserver"
